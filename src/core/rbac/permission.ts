...
export const PERMISSIONS = {
  ...
  // Game Categories
  GAME_CATEGORIES_READ: 'admin.game-categories.read',
  GAME_CATEGORIES_WRITE: 'admin.game-categories.write',
  GAME_CATEGORIES_DELETE: 'admin.game-categories.delete',

  // Games
  GAMES_READ: 'admin.games.read',
  GAMES_WRITE: 'admin.games.write',
  GAMES_DELETE: 'admin.games.delete',
} as const;
